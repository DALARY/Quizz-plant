<?php
	...
	if(empty($_SESSION['langueauto'])){
		$lang = $_SERVER['HTTP_ACCEPT_LANGUAGE'];//détection automatique de la langue
		    	...
		    	<div class="modal-content">
		    		<div class="modal-header">
			      	...
			      	<div class="modal-body">
			        	...
			        	<input type="password" name="password" title="<?php print $_titlemdp ?>" placeholder="<?php print $_mdp ?>" id="mdp1" pattern="(?=^.{8,}$)((?=.*\d)(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required>

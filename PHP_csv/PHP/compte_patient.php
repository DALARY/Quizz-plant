  ...
  <head>
    ...
    <body>
        ...
        <div id="overlay3">
                <div class="popup_block">
                    ...
                    <div>
                        ...
                        <label>Name :</label>
                        <input type="text" name="newname" placeholder="Name" value="<?php print $tableaux2["nom_patient"]; ?>" />
                        
                        <label>Prénom :</label>
                        <input type="text" name="newprenom" placeholder="Prénom" value="<?php print $tableaux2["prenom_patient"]; ?>" />

                        <label>Date de naissance :</label>
                        <input type="text" name="newnaissance" placeholder="Date de naissance" value="<?php print $tableaux2["naissance_patient"]; ?>" />

                        <label>Mail :</label>
                        <input type="text" name="newmail" placeholder="Email" value="<?php print $tableaux2["email_patient"]; ?>" />
                        
                        <label>Adresse :</label>
                        <input type="text" name="newadresse" placeholder="Adresse" value="<?php print $tableaux2["adresse_patient"]; ?>" />

                        <label>Code postal :</label>
                        <input type="text" name="newcodepostal" placeholder="Code postal" value="<?php print $tableaux2["code_postal_patient"]; ?>" />

                        <label>Ville :</label>
                        <input type="text" name="newville" placeholder="Ville" value="<?php print $tableaux2["ville_patient"]; ?>" />
                        ...
                        <input name="maj" type="submit" value="Mettre à jour mon profil !" />
        ...
        <div class="row no-gutters">
            ...
            <img src="image/patient2.jfif" class="card-img" alt="...">
            </div>
            <div class="col-md-8" style="height:200px">
            <div class="card-body">
            <div aligne="center">
         <h2>Information du compte</h2>
         <b>Nom : </b><?php print $tableaux2["nom_patient"]."&nbsp;&nbsp;"; ?>
         <b>Prénom : </b><?php  print $tableaux2["prenom_patient"]."<br>"; ?>
         <b>Date de naissance : </b><?php  print $tableaux2["naissance_patient"]."<br>"; ?>
         <b>Email : </b><?php print $tableaux2["email_patient"]."<br>"; ?>
         <b>Adresse : </b><?php  print $tableaux2["adresse_patient"]."&nbsp;&nbsp;"; ?>
         <b>Code postal :</b> <?php  print $tableaux2["code_postal_patient"]."&nbsp;&nbsp;"; ?>
         <b>ville :</b> <?php  print $tableaux2["ville_patient"]."<br>"; ?>
         <b>Téléphone : </b><?php print $tableaux2["telephone_patient"]."&nbsp;&nbsp;"; ?>
